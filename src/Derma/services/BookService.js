...
export default class BookService {
  ...
  static payBooking = (bookingId, price, paymentMethod, corporate) => {
    return API.post(
      `/api/derma/book/paybooking?id=${bookingId}&paymentmethod=${paymentMethod}&corporate=${corporate}&price=${price}`
    );
  };
  ...
  static refundBooking = (bookingId) => {
    return API.post(`/api/derma/payment/refundpayment`, {
      bookingId: bookingId,
    });
  };
  ...
  static getBookingsCountByDateStrandTime = (dateStr, time, source) => {
    return API.get(
      `/api/derma/book/getbookingscountbydatestrandtime?date=${dateStr}&time=${time}`,
  ...
  static getBookingsByDateStrandTime = (dateStr, time) => {
    return API.get(
      `/api/derma/book/getbookingsbydatestrandtime?date=${dateStr}&time=${time}`
    );
  };

  static getAllBookingsCountByDateStr = (dateStr) => {
    return API.get(
      `/api/derma/book/getallbookingscountbydatestr?date=${dateStr}`
    );
  };

  static getAllBookingsCountByDateStrandTime = (dateStr, time, source) => {
    return API.get(
      `/api/derma/book/getallbookingscountbydatestrandtime?date=${dateStr}&time=${time}`,
      { cancelToken: source.token }
    );
  };
  ...
  static getAllBookingsByDateStrandTime = (dateStr, time) => {
    return API.get(
      `/api/derma/book/getallbookingsbydatestrandtime?date=${dateStr}&time=${time}`
    );
  };
  ...
  static changeToPatientAttended = (id, payload) => {
    return API.post(
      `/api/derma/book/changetopatientattended?id=${id}`,
      payload
    );
  };
