...
export const MenuList = [
    ...
    {index: 1, id:`booknewtest`, title: `Book a New Test`, icon : <TodayIcon style={{fontSize:"1.9rem"}}/>}, 
    {index: 2, id:`mytests`, title: `My Tests`, icon : <ColorizeIcon style={{fontSize:"1.9rem"}}/>},
