...
export default class BookService {
  ...
  static payBooking = (bookingId, price, paymentMethod, corporate) => {
    return API.post(
      `/api/optimalvision/book/paybooking?id=${bookingId}&paymentmethod=${paymentMethod}&corporate=${corporate}&price=${price}`
    );
  };
  ...
  static refundBooking = (bookingId) => {
    return API.post(`/api/optimalvision/payment/refundpayment`, {
      bookingId: bookingId,
    });
  };
  ...
  static getBookingsStatsByDateStr = (dateStr) => {
    return API.get(
      `/api/optimalvision/book/getbookingsstatsbydatestr?date=${dateStr}`
    );
  };

  static getBookingsCountByDateStr = (dateStr) => {
    return API.get(
      `/api/optimalvision/book/getbookingscountbydatestr?date=${dateStr}`
    );
  };
  ...
  static getBookingsCountByDateStrandTime = (dateStr, time, source) => {
    return API.get(
      `/api/optimalvision/book/getbookingscountbydatestrandtime?date=${dateStr}&time=${time}`,
  ...
  static getBookingsByDateStrandTime = (dateStr, time) => {
    return API.get(
      `/api/optimalvision/book/getbookingsbydatestrandtime?date=${dateStr}&time=${time}`
    );
  };

  static getAllBookingsCountByDateStr = (dateStr) => {
    return API.get(
      `/api/optimalvision/book/getallbookingscountbydatestr?date=${dateStr}`
    );
  };

  static getAllBookingsCountByDateStrandTime = (dateStr, time, source) => {
    return API.get(
      `/api/optimalvision/book/getallbookingscountbydatestrandtime?date=${dateStr}&time=${time}`,
      { cancelToken: source.token }
    );
  };
  ...
  static getAllBookingsByDateStrandTime = (dateStr, time) => {
    return API.get(
      `/api/optimalvision/book/getallbookingsbydatestrandtime?date=${dateStr}&time=${time}`
    );
  };
  ...
  static changeToPatientAttended = (id, payload) => {
    return API.post(
      `/api/optimalvision/book/changetopatientattended?id=${id}`,
      payload
    );
  };
  ...
  static updateBookingTime = (payload) => {
    return API.post(
      `/api/optimalvision/book/updatebookappointmenttime`,
      payload
    );
  };
  ...
  static getRecentBookingsAll = (limit) => {
    if (!limit) limit = 25;
    return API.get(
      `/api/optimalvision/book/getrecentbookingsall?limit=${limit}`
    );
  };
}