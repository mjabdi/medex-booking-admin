      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6} lg={4}>
          <Paper className={fixedHeightPaper}>
           <div className={classes.cardHeader}>
            ...
            <p style={{color:"#777", lineHeight:"1.5rem", textAlign:"justify"}}>
              You can book a new <span>Medical Test</span> online. If you have already booked a test with us, you don't need to fill out every information again,
            ...
            <Grid container justify="center" alignItems="center" spacing={1} style={{position:"absolute", bottom:"20px"}}> 
               <Grid item>  
                  <Button
                      ...
                      onClick={() =>  history.push(`/${getMenuId(1)}`)}
                    >
                      Book Now
                    </Button>               
               </Grid>
        ...
        <Grid item xs={12} md={6} lg={4}>
          <Paper className={fixedHeightPaper}>
           ...
           <p style={{color:"#777", lineHeight:"1.5rem", textAlign:"justify"}}>
              We keep all your test results for you. You can see history of all your test results in one place. 
            ...
            <Grid container justify="center" alignItems="center" spacing={1} style={{position:"absolute", bottom:"20px"}}> 
               <Grid item>  
                  <Button
                      color="primary"
                      variant="contained"
                      style={{ color: "#fff", marginTop:"20px",width:"200px" }}
                      onClick={() =>  history.push(`/${getMenuId(2)}`)}
                    >
                      Go to My Tests
                    </Button>               
               </Grid>
            ...
            <Grid container justify="center" alignItems="center" spacing={1} style={{position:"absolute", bottom:"20px"}}> 
               <Grid item>  
                  <Button
                      ...
                      variant="contained"
                      style={{ color: "#fff",width:"200px" }}
                      onClick={() =>  history.push(`/${getMenuId(3)}`)}
                    >
                      Change My password
                    </Button>               
               </Grid>
